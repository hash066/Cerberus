...
// llamacppRealForwardActivation runs a layer range through the real llama.cpp
// helper subprocess. Only reachable when llamacppSupported() is true; the
// engine's mock fallback handles every other platform/configuration.
