...
#[doc(hidden)]
macro_rules! __export_world_fixture_cabi {
...
#[doc(hidden)]
pub(crate) use __export_world_fixture_cabi;
#[rustfmt::skip]
...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_fixture_impl {
    ($ty:ident) => {
        self::export!($ty with_types_in self);
    };
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*:: __export_world_fixture_cabi!($ty with_types_in
        $($path_to_types_root)*);
    };
}
#[doc(inline)]
pub(crate) use __export_fixture_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:cerberus:wasi-fixture@0.1.0:fixture:encoded world"
)]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 1514] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xec\x0a\x01A\x02\x01\
...
or.to-debug-string\x01\x02\x03\0\x13wasi:io/error@0.2.0\x05\x01\x01B\x0a\x04\0\x08\
...
@0.2.0\x05\x02\x02\x03\0\x01\x05error\x02\x03\0\x02\x08pollable\x01B(\x02\x03\x02\
...
\x18\x03\0\x15wasi:io/streams@0.2.0\x05\x05\x02\x03\0\x03\x0doutput-stream\x01B\x05\
\x02\x03\x02\x01\x06\x04\0\x0doutput-stream\x03\0\0\x01i\x01\x01@\0\0\x02\x04\0\x0a\
get-stdout\x01\x03\x03\0\x15wasi:cli/stdout@0.2.0\x05\x07\x01@\0\0y\x04\0\x03run\
\x01\x08\x04\0#cerberus:wasi-fixture/fixture@0.1.0\x04\0\x0b\x0d\x01\0\x07fixtur\
