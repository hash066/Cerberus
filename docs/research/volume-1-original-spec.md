# Volume I — the original P2P hyper-computer spec (historical)

> **Provenance note.** This is the original narrative specification of Project
> Cerberus, retained verbatim for provenance. It previously lived inside the
> repository README. The canonical, normative spec is
> [ARCHITECTURE.md](../../ARCHITECTURE.md); the narrative debate and
> Go-To-Market live in [ideadumpp2.md](ideadumpp2.md), with per-vertical deep
> dives under [docs/verticals/](../verticals/). Where this document and
